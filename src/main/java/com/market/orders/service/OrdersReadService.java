...
public class OrdersReadService {
    ...
    public List<MarketOrderedOrdersResponse> getMarketOrderedOrders(Long marketId) {
        List<MarketOrderedOrdersResponse> response = new ArrayList<>();

        // 가게의 접수된 주문 목록 조회
        List<Orders> orderedOrders = ordersRepository.getMarketOrderedOrdersByMarketIdAndOrdersStatus(marketId, OrdersStatus.ORDERED);
