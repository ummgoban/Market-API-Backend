...
public class BucketController {
    ...
    @GetMapping
    public ResponseEntity<BfResponse<BucketProductResponse>> findBucket(@AuthenticationPrincipal PrincipalDetails principalDetails) {
    ...
    public ResponseEntity<BfResponse<BucketDiscriminationResponse>> discriminateBucket(
        ...
        return ResponseEntity.ok(new BfResponse<>(new BucketDiscriminationResponse(
                bucketService.discriminateBucket(marketId, Long.parseLong(principalDetails.getUsername())))));
    }
